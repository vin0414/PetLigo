        ...
        if(!$validation){
            ...
            if(count($data) != 0)
            {
                ...
                {                    
                    ...
                    <ol>
                    <li>Visit our website at <a href='https://petligo.shop/'>https://petligo.shop/</a>.</li>
                    <li>Log in to your account.</li>
                    <li>Navigate to the \"Profile\" section.</li>
                    <li>Enter your new password and confirm it.</li>
                    <li>Save the changes.</li>
                    </ol>
                    <p>If you did not request this password reset, or if you encounter any issues, please contact our team at petligo2023@gmail.com immediately.</p>
                    ...
                    <p>Best regards,</p>
                    <p>Petligo - Grooming Services </p>
                    ";
                    $subject = "Password Successfully Reset - Petligo";
                    $email->setSubject($subject);
                    $email->setMessage($template);
                    $email->send();
            ...
            {
                session()->setFlashdata('fail','Invalid! Email does not exist');
                return redirect()->to('forgot-password')->withInput();
            }
