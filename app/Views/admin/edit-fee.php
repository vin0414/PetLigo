...
<html>
	...
	<body>
				...
				<div class="sidebar-menu">
					<ul id="accordion-menu">
						...
						<li class="dropdown">
							...
							<ul class="submenu">
								<li><a href="javascript:void(0);" class="active">Edit Membership</a></li>
							</ul>
						</li>
		...
		<div class="main-container">
			<div class="pd-ltr-20">
				<div class="card-box">
                    <div class="card-header">Edit Membership Fee
                    ...
                    <div class="card-body">
                        ...
                        <?php endif; ?>
                        <?php if($fee): ?>
                        <form method="post" class="row g-3" id="frmUpdate" action="<?=site_url('update-fee')?>">
