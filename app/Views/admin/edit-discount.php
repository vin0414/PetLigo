...
<html>
	<head>
		<!-- Basic Page Info -->
		<meta charset="utf-8" />
		<title>PetLigo - Edit Discount</title>
	...
	<body>
				...
				<div class="sidebar-menu">
					<ul id="accordion-menu">
						...
						<li class="dropdown">
							...
							<ul class="submenu">
								<li><a href="javascript:void(0);" class="active">Edit Discount</a></li>
							</ul>
						</li>
		...
		<div class="main-container">
			<div class="pd-ltr-20">
				<div class="card-box">
                    <div class="card-header">Edit Discount
                    ...
                    <div class="card-body">
                        ...
                        <?php endif; ?>
                        <?php if($discount): ?>
                        <form method="post" class="row g-3" id="frmUpdate" action="<?=site_url('update-discount')?>">
                            ...
                            <div class="col-12 form-group">
                                <div class="row g-3">
                                    ...
                                    <div class="col-lg-4">
                                        <label>From</label>
                                        <input type="date" class="form-control" name="fromdate" value="<?=$discount['FromDate'] ?>"/>
                                    </div>
                                    <div class="col-lg-4">
                                        <label>To</label>
                                        <input type="text" class="form-control" name="todate" value="<?=$discount['ToDate'] ?>"/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 form-group">
